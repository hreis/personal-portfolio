  ...
  return (
    <div className="py-2 px-4 text-[#8F8CA8]">
      ...
      <nav className="mt-4 flex flex-col">
        ...
        <SubMenu defaultOpen title="its-me">
          ...
          <Folder title="Terminal">
            <File href="/terminal/general" disabled={true}>
              <Terminal size={16} />
              General
            </File>
            <File href="/terminal/fish" disabled={true}>
              <Cog size={16} />
              config.fish
            </File>
          </Folder>
          ...
          <Folder title="Others">
            <File href="/others/dev-setup" disabled={true}>
              <Cpu size={16} />
              dev.setup
            </File>
            <File href="/others/gaming-setup" disabled={true}>
              <Joystick size={16} />
              gaming.setup
            </File>
